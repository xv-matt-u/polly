...
if(DEFINED POLLY_ARM_OPENWRT_LINUX_MUSLGNUEABI_STATIC_CXX14_)
  return()
else()
  set(POLLY_ARM_OPENWRT_LINUX_MUSLGNUEABI_STATIC_CXX14_ 1)
endif()

include("${CMAKE_CURRENT_LIST_DIR}/utilities/polly_init.cmake")

polly_init(
    "Linux / gcc / OpenWRT / MUSL / c++14 support / cortex-a9 / static"
    "Unix Makefiles"
)
