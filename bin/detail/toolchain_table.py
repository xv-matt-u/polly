...
toolchain_table = [
    ...
    Toolchain('android-ndk-r18b-api-21-arm64-v8a-clang-libcxx-cxx14', 'Unix Makefiles'),
    Toolchain('android-ndk-r18b-api-21-armeabi-v7a-clang-libcxx-cxx14', 'Unix Makefiles'),
    Toolchain('android-ndk-r18b-api-21-x86-64-clang-libcxx-cxx14', 'Unix Makefiles'),
    Toolchain('android-ndk-r18b-api-21-x86-clang-libcxx-cxx14', 'Unix Makefiles'),
...
if platform.system() == 'Darwin':
  toolchain_table += [
      Toolchain('ios', 'Xcode'),
      Toolchain('ios-12-2-dep-10-0-device-bitcode-cxx14', 'Xcode', ios_version='12.2'),
      ...
      Toolchain('ios-nocodesign-12-2-dep-10-0-bitcode-cxx14', 'Xcode', nocodesign=True),
...
if os.name == 'posix':
  toolchain_table += [
      ...
      Toolchain('arm-openwrt-linux-muslgnueabi-static-cxx14', 'Unix Makefiles'),
